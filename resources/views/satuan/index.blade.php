    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                ...
                <h1>Kelola Satuan Barang</h1>
                <p>Gunakan satuan yang konsisten untuk setiap item inventaris.</p>
            </div>
            <a href="{{ route('satuan.create') }}" class="btn-add">
            ...
            <div class="filter-wrapper">
                <form method="GET" action="{{ route('satuan.index') }}" class="filter-form">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('satuan.index') }}" class="btn-reset">Reset</a>
                    </div>
                </form>
            </div>
                    ...
                    <tbody>
                        @forelse($satuans as $index => $satuan)
                            <tr>
                                ...
                                <td><span class="badge-satuan">{{ $satuan->nama_satuan }}</span></td>
                                <td style="color:#64748b;">{{ optional($satuan->created_at)->format('d-m-Y H:i:s') ?? '-' }}</td>
                                <td style="color:#64748b;">{{ optional($satuan->updated_at)->format('d-m-Y H:i:s') ?? '-' }}</td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="empty-state">
                                    ...
                                    <h5>Belum ada satuan</h5>
                                    <p>Tambahkan satuan barang pertama.</p>
                                    <a href="{{ route('satuan.create') }}" class="btn-empty">Tambah Data</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
