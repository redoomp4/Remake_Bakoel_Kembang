    ...
    <div style="background:#FAF9F6; min-height:100vh; padding:2rem 1.25rem;">
        <div style="max-width:900px; margin:auto;">
            <div
                ...
                <div>
                    <p
                        style="color:#8FA882; font-weight:800; font-size:.75rem; text-transform:uppercase; letter-spacing:.08em;">
                        Master Data</p>
                    <h4 style="color:#0B4F35; font-size:1.9rem; font-weight:900; margin:0;">Tambah Item</h4>
                </div>
            ...
            <form action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(240px,1fr)); gap:1.25rem;">
                    <div style="grid-column:1/-1;"><label for="nama_barang"
                            style="display:block; font-weight:800; color:#475569; margin-bottom:.5rem;">Nama Barang
                            *</label>
                    ...
                    <div><label for="harga_dasar"
                            style="display:block; font-weight:800; color:#475569; margin-bottom:.5rem;">Harga Dasar
                            *</label><input type="number" id="harga_dasar" name="harga_dasar"
                    ...
                    <div><label for="stok_minimum"
                            style="display:block; font-weight:800; color:#475569; margin-bottom:.5rem;">Stok Minimum
                            *</label><input type="number" id="stok_minimum" name="stok_minimum"
                            value="{{ old('stok_minimum', $item->stok_minimum ?? '') }}" required
                            style="width:100%; padding:.85rem 1rem; border:1px solid #E4E4D9; border-radius:.75rem;"></div>
                    <div><label for="id_kategori"
                            style="display:block; font-weight:800; color:#475569; margin-bottom:.5rem;">Kategori
                            *</label><select id="id_kategori" name="id_kategori" required
                    ...
                    <div><label for="id_satuan"
                            style="display:block; font-weight:800; color:#475569; margin-bottom:.5rem;">Satuan
                            *</label><select id="id_satuan" name="id_satuan" required
                            style="width:100%; padding:.85rem 1rem; border:1px solid #E4E4D9; border-radius:.75rem;">
                    ...
                    <div style="grid-column:1/-1;"><label for="deskripsi"
                            style="display:block; font-weight:800; color:#475569; margin-bottom:.5rem;">Deskripsi</label>
                        <textarea id="deskripsi" name="deskripsi" rows="3"
                            style="width:100%; padding:.85rem 1rem; border:1px solid #E4E4D9; border-radius:.75rem;">{{ old('deskripsi') }}</textarea>
                    </div>
                ...
                <button type="submit"
                    style="margin-top:1.5rem; background:#0B4F35; color:#fff; border:0; padding:.9rem 1.5rem; border-radius:.85rem; font-weight:800; cursor:pointer;">Simpan
                    Item</button>
            </form>
        </div>
    </div>
