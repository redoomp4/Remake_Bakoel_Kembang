    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Tandai kondisi barang supaya pengelolaan aset lebih mudah.</p>
            </div>
            <a href="{{ route('kondisi.create') }}" class="btn-add">
                <i class="fas fa-plus-circle me-2"></i> Tambah Kondisi Baru
            </a>
        </div>
                ...
                <form method="GET" action="{{ route('kondisi.index') }}" class="filter-form">
                    <div class="filter-group">
                        ...
                        <input type="text" id="search" name="search"
                               ...
                               placeholder="Ketik nama kondisi...">
                    </div>
                    <div class="filter-actions">
                        <button class="btn-filter" type="submit">
                            <i class="fas fa-search me-1"></i> Filter
                        </button>
                        <a href="{{ route('kondisi.index') }}" class="btn-reset">Reset</a>
                    </div>
                </form>
            </div>
                    ...
                    <tbody>
                        @forelse($kondisis as $index => $kondisi)
                            <tr>
                                ...
                                <td><span class="badge-kondisi">{{ $kondisi->nama_kondisi }}</span></td>
                                <td>{{ $kondisi->deskripsi ?? '-' }}</td>
                                <td style="color:#64748b;">{{ optional($kondisi->created_at)->format('d-m-Y H:i:s') ?? '-' }}</td>
                                <td style="color:#64748b;">{{ optional($kondisi->updated_at)->format('d-m-Y H:i:s') ?? '-' }}</td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <form action="{{ route('kondisi.destroy', $kondisi->id) }}"
                                              method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="empty-state">
                                    ...
                                    <h5>Belum ada kondisi</h5>
                                    <p>Tambahkan kondisi barang pertama.</p>
                                    <a href="{{ route('kondisi.create') }}" class="btn-empty">Tambah Data</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
