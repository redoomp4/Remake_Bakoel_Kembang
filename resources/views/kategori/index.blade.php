    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                ...
                <h1>Kelola Kategori Bunga</h1>
                <p>Atur kategori agar pencatatan inventaris lebih rapi.</p>
            </div>
            ...
            <div class="filter-wrapper">
                <form method="GET" action="{{ route('kategori.index') }}" class="filter-form">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('kategori.index') }}" class="btn-reset">Reset</a>
                    </div>
                </form>
            </div>
                    ...
                    <tbody>
                        @forelse($kategoris as $index => $kategori)
                            <tr>
                                ...
                                <td><span class="badge-kategori">{{ $kategori->kategori }}</span></td>
                                <td>{{ $kategori->deskripsi ?? '-' }}</td>
                                <td style="color:#64748b;">{{ optional($kategori->created_at)->format('d-m-Y H:i:s') ?? '-' }}</td>
                                <td style="color:#64748b;">{{ optional($kategori->updated_at)->format('d-m-Y H:i:s') ?? '-' }}</td>
                                <td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="empty-state">
                                    ...
                                    <p>Tambahkan kategori pertama untuk mulai mengelola data.</p>
                                    <a href="{{ route('kategori.create') }}" class="btn-empty">Tambah Data</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
