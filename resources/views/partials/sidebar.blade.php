<aside class="w-full lg:w-72 bg-white border-r border-brand-accent p-4 md:p-6 shrink-0" aria-label="Navigasi admin">
    ...
    <nav class="flex flex-col gap-2">
        ...
        <a href="{{ route('dashboard.penjual') }}"
            class="flex items-center gap-3 px-4 py-3.5 rounded-xl font-extrabold {{ request()->routeIs('dashboard.penjual') ? 'bg-brand-emerald text-white shadow-md' : 'text-brand-slate hover:bg-brand-offwhite' }}">
